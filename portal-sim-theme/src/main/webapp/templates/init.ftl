...
<#assign
	...
	images_folder2 = theme_display.getPathThemeTemplates()
...
<#assign js_jquery_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${javascript_folder}/jquery-3.3.1.min.js")) />
<#assign js_jquery_mask_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${javascript_folder}/jquery.mask.min.js")) />
<#assign js_mask_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${javascript_folder}/mask.js")) />
<#-- ---------- Portal Sim ---------- -->
<#assign css_estilo_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${css_folder}/estilo.css")) />
<#assign css_bootstrap_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${css_folder}/bootstrap.css")) />
<#assign js_bootstrap_file = htmlUtil.escape(portalUtil.getStaticResourceURL(request, "${javascript_folder}/bootstrap.js")) />
<#-- ---------- Portal Sim .---------- -->
